   ...
   <!-- For alternative headers START PASTE here -->
    ...
    <div class="main">
      ...
      <div class="main-navigation">
        ...
        <dl class="nav3-grid">
          <dt><a href="/CMS/kbaseC.jsp?consti=<%=consti%>">Knowledge Base</a></dt>
          <dt><a href="/CMS/download_reportsC.jsp?consti=<%=consti%>">Reports</a></dt>
            <dt><a href="/CMS/Funds_main?consti=<%=consti%>">Funds</a></dt>
            <dt><a href="/CMS/mapC.jsp?consti=<%=consti%>">Map</a></dt>
            <%if(consti.equals((String)session.getAttribute("Consti")) && session.getAttribute("Access").toString().charAt(4)!='1') {%>
            <dt><a href="/CMS/chatC.jsp?consti=<%=consti%>" target="new">Chat</a></dt>
           <%}%>	
           <%if(consti.equals((String)session.getAttribute("Consti")) && session.getAttribute("Access").toString().charAt(4)=='3') {%>
           <dt><a href="/CMS/chat_notifyC.jsp?consti=<%=consti %>">Chat Notification</a></dt>
           <%} %>
          </dl>                                 
