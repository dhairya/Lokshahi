...
File reportFile = new File(application.getRealPath("/reports/FUNDS_USED.jrxml"));
...
if( "pdf".equalsIgnoreCase(reporttype) )
{
	...
	reportFile2+"\\"+consti+"_FUND_UTILIZATION.pdf");
...
else if( "rtf".equalsIgnoreCase(reporttype) )
{
  ...
  File destFile = new File(reportFile2+"\\"+consti+"_FUND_UTILIZATION.rtf");
...
else if( "html".equalsIgnoreCase(reporttype) )
{
	...
	JasperExportManager.exportReportToHtmlFile(jasperPrint, reportFile2+"\\"+consti+"_FUND_UTILIZATION.html");
	//response.setContentType("application/pdf");
...
else if( "xls".equalsIgnoreCase(reporttype) )
{
  ...
  File destFile = new File(reportFile2+"\\"+consti+"_FUND_UTILIZATION.xls");
...
else if( "csv".equalsIgnoreCase(reporttype) )
{
  ...
  File destFile = new File(reportFile2+"\\"+consti+"_FUND_UTILIZATION.csv");
...
{
  File destFile = new File(reportFile2+"\\"+consti+"_FUND_UTILIZATION.odf");
