...
File reportFile = new File(application.getRealPath("/reports/USER_DETAILS.jrxml"));
...
if( "pdf".equalsIgnoreCase(reporttype) )
{
	...
	reportFile2+"\\"+consti+"_USER_DETAILS.pdf");
...
else if( "rtf".equalsIgnoreCase(reporttype) )
{
  ...
  File destFile = new File(reportFile2+"\\"+consti+"_USER_DETAILS.rtf");
...
else if( "html".equalsIgnoreCase(reporttype) )
{
	...
	JasperExportManager.exportReportToHtmlFile(jasperPrint, reportFile2+"\\"+consti+"_USER_DETAILS.html");
	//response.setContentType("application/pdf");
...
else if( "xls".equalsIgnoreCase(reporttype) )
{
  ...
  File destFile = new File(reportFile2+"\\"+consti+"_USER_DETAILS.xls");
...
else if( "csv".equalsIgnoreCase(reporttype) )
{
  ...
  File destFile = new File(reportFile2+"\\"+consti+"_USER_DETAILS.csv");
...
{
  File destFile = new File(reportFile2+"\\"+consti+"_USER_DETAILS.odf");
