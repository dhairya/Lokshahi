...
String POLLNO = (String)request.getAttribute("pollno");
Map parameters = new HashMap();
parameters.put("table", tablename);
parameters.put("consti", consti);
parameters.put("POLLNO", POLLNO);
//load 

File reportFile = new File(application.getRealPath("/reports/POLLS_REPORT.jrxml"));
...
if( "pdf".equalsIgnoreCase(reporttype) )
{
	...
	reportFile2+"\\"+consti+"_POLLS_REPORT.pdf");
...
else if( "rtf".equalsIgnoreCase(reporttype) )
{
  ...
  File destFile = new File(reportFile2+"\\"+consti+"_POLLS_REPORT.rtf");
...
else if( "html".equalsIgnoreCase(reporttype) )
{
	...
	JasperExportManager.exportReportToHtmlFile(jasperPrint, reportFile2+"\\"+consti+"_POLLS_REPORT.html");
	//response.setContentType("application/pdf");
...
else if( "xls".equalsIgnoreCase(reporttype) )
{
  ...
  File destFile = new File(reportFile2+"\\"+consti+"_POLLS_REPORT.xls");
...
else if( "csv".equalsIgnoreCase(reporttype) )
{
  ...
  File destFile = new File(reportFile2+"\\"+consti+"_POLLS_REPORT.csv");
...
{
  File destFile = new File(reportFile2+"\\"+consti+"_POLLS_REPORT.odf");
