      ...
      <div class="main-content">  <div id="translation"></div>
        ...
        <div class="column1-unit">
          <p>&nbsp;</p>
            ...
            <br />
            &nbsp;&nbsp;&nbsp;
            <%if(rs.getString("NICKNAME").equals(session.getAttribute("Nick"))){ %>
            <input type="button" value="Delete" id="Delete" onclick="buttonid(this.id)" /><br />
            <%}else{ %>
            <input type="button" value="Delete" id="Delete" disabled="true" /><br />
            <%} %>
