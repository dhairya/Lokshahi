    ...
    <div class="main-content">
      <div id="article">
        ...
        <div class="column1-unit">
          <%String done = "done"; %>
          <%String codes = (String)session.getAttribute("Consti"); %>
          <h2><a href="/CMS/Grievance_add2?consti=<%=consti%>&ward=<%=ward%>">Post a Problem </a></h2>
              ...
              <div class="tabs-container">
                <div class="tab" id="tab1">
                  ...
                  <select name="filter" id="filter">
                    ...
                    <option value="10">Challenged once</option>
                    <option value="20">Challenged twice</option>
                    <option value="30">Challenged thrice</option>
                    <option value="40">Challenged four times</option>
                  </select>
                  </label>
                ...
                <div class="tab" id="tab2">
                  <p>&nbsp;
                    <input type="button" value="My Solvable Problems" id="mysolve" onclick="search(this.id)" />
                  	&nbsp;
                    <input type="button" value="My Problems" id="myprob" onclick="search(this.id)" />
                    &nbsp;
                    <input type="button" value="Joined Problems" id="joined" onclick="search(this.id)" />
                    &nbsp;
