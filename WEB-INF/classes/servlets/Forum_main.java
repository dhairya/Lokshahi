...
/**
 * Servlet implementation class for Servlet: Forum_main
 *
 */
 public class Forum_main extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			PreparedStatement ps = con.prepareStatement("SELECT * FROM " + constiB + "_" + wardB
					+ "_FORUM ORDER BY FOR_ID DESC " + "LIMIT 21");
			rs = ps.executeQuery();
