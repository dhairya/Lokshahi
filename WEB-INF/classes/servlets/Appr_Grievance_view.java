...
/**
 * Servlet implementation class for Servlet: Appr_Grievance_view
 *
 */
 public class Appr_Grievance_view extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
   
    /* (non-Java-doc)
	 * @see javax.servlet.http.HttpServlet#HttpServlet()
	 */
	public Appr_Grievance_view() {
		super();
	}   	
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
	        ...
	        RequestDispatcher view = request.getRequestDispatcher("./"+priv+"/approve_view_grievance.jsp?consti="+constiB+"&ward="+wardB);       
