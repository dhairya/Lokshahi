...
/**
 * Servlet implementation class for Servlet: Appr_Grievance_prev
 *
 */
 public class Appr_Grievance_prev extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
   
    /* (non-Java-doc)
	 * @see javax.servlet.http.HttpServlet#HttpServlet()
	 */
	public Appr_Grievance_prev() {
		super();
	}   	
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String url = constiB + "_" + wardB + "_TEMPGRIEVANCES";
				...
				ps = con.prepareStatement("SELECT REF_ID, TITLE, NICKNAME " +
