 ...
 *
 */
 public class Poll_view extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
	        ...
	        RequestDispatcher view = request.getRequestDispatcher("./"+priv+"/poll_vote.jsp?consti="+constiB+"&ward="+wardB);       
